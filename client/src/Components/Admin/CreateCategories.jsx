...
function CreateCategories() {
  const url = `${import.meta.env.VITE_USER_AUTH}/api/category/get-categories`;
  ...
  const deleteCategory = async (id) => {
    const response = await axios.delete(
      `${import.meta.env.VITE_USER_AUTH}/api/category/delete-category/${id}`,
      {
        headers: {
  ...
  const createCategory = async (e) => {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_USER_AUTH}/api/category/create-category`,
      {
        method: "post",
        headers: {
  ...
  const updateCategory = async(category_id,u_catname)=>{
    const response = await fetch(
      `${import.meta.env.VITE_USER_AUTH}/api/category/update-category/${category_id}`,
      {
        method: "put",
        headers: {
          "Content-Type": "application/json",
