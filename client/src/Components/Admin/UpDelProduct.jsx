...
function UpDelProduct() {
  ...
  const getSingleProduct = async () => {
    const { data } = await axios.get(
      `${import.meta.env.VITE_USER_AUTH}/api/product/${prams.slug}`
    );
    setProductVariable({
      ...productVariable,
  ...
  const deleteProduct = async (id) => {
    try {
      ...
      const response = await axios.delete(
        `${import.meta.env.VITE_USER_AUTH}/api/product/delete-product/${id}`,
        {
          headers: {
  ...
  const updateProduct = async (e) => {
    ...
    const response = await fetch(
      `${import.meta.env.VITE_USER_AUTH}/api/product/update-product/${pid}`,
      {
        method: "PUT",
        headers: {
